...
par(mfrow=c(2,2))
plot(data_sub1$Global_active_power, type = "l", xlim=c(0, 3000), xaxt="n", ylab = "Global Active Power", xlab=" ")
axis(1, at=c(0, 1500, 3000), labels=z, cex.axis=1)
plot(data_sub1$Voltage, type = "l", xlim=c(0, 3000), xaxt="n", ylab = "Voltage", xlab="datetime ")
axis(1, at=c(0, 1500, 3000), labels=z, cex.axis=1)
...
axis(1, at=c(0, 1500, 3000), labels=z, cex.axis=1)
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), fill = c("black", "red", "blue"), cex=1, bty="n")
plot(data_sub1$Global_reactive_power, type = "l", xlim=c(0, 3000), xaxt="n", ylab = "Global_rective_power", xlab=" ")
axis(1, at=c(0, 1500, 3000), labels=z, cex.axis=1)
dev.off()
